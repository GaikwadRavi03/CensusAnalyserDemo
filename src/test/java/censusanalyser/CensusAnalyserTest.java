...
public class CensusAnalyserTest {
    ...
    @Test
    public void givenUSCensusData_whenSortedOnPopulation_ShouldReturnHighestPopulationState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
    ...
    @Test
    public void givenUSCensusData_whenSortedOnPopulation_ShouldReturnLowestPopulationState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
            String stateWiseSortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.population);
    ...
    @Test
    public void givenUSCensusData_whenSortedOnArea_ShouldReturnHighestAreaState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
    ...
    @Test
    public void givenUSCensusData_whenSortedOnArea_ShouldReturnLowestAreaState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
            String stateWiseSortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.areaInSqKm);
    ...
    @Test
    public void givenUSCensusData_whenSortedDensity_ShouldReturnLowestDensityState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
    ...
    @Test
    public void givenUSCensusData_whenSortedDensity_ShouldReturnHighestDensityState() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
            String stateWiseSortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.densityPerSqKm);
    ...
    @Test
    public void givenUSCensusData_whenSortedPopulation_ForUS_ShouldReturnHighest_PopulationStateWithDensity() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
            String stateWiseSortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.population);
    ...
    @Test
    public void givenUSCensusData_whenSortedPopulation_ForUS_ShouldReturnLowest_PopulationStateWithDensity() {
        CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.US);
        try {
            censusAnalyser.loadCensusData(US_CENSUS_DATA_CSV_FILE_PATH);
            String stateWiseSortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.population);
    ...
    @Test
    public void givenStateCSV_FileSortPopulationWithDensity_ShouldReturnLowestPopulatedState() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.INDIA);
            censusAnalyser.loadCensusData(INDIA_CENSUS_CSV_FILE_PATH, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.population);
    ...
    @Test
    public void givenStateCSV_FileSortPopulationWithDensity_ShouldReturnHighestPopulatedState() {
        try {
            CensusAnalyser censusAnalyser = new CensusAnalyser(CensusAnalyser.Country.INDIA);
            censusAnalyser.loadCensusData(INDIA_CENSUS_CSV_FILE_PATH, INDIA_STATE_CODE_CSV_FILE_PATH);
            String sortedCensusData = censusAnalyser.getStateWiseSortedCensusData(SortingField.population);
